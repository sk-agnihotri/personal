        ...
        <div className='bg-con'>
            ...
            <div className='cont'>
                <div className='social-container'>
                    ...
                    <a href="https://skype.com/en/agnihotri.nitw" className="skype"><i className="fa fa-skype fa-2x"></i></a>
                    <a href="www.linkedin.com/in/s-k-agnihotri/" className="linkedin"><i className="fa fa-linkedin fa-2x"></i></a>
